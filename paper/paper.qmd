...
With the McMurdo Dry Valleys being very close to the largest research base on the continent, McMurdo Station, the pressures on this unique environment from human activity are increasing. 
Understanding the scope and implications of human activity in key parts of Antarctica is critical to supporting the environmental management of the continent.
...
A recommendation in the final report of this meeting was for member countries to encourage more research on how human activity has impact on Antarctica and its ecosystems [@ATCM1970 Recommendation VI-4].
By the mid-1980s, it was recognised that scientific activity, particularly the logistics required to support that activity, required additional scrutiny, but also that scientific activity could pose a greater threat to Antarctica’s ecosystems than tourism [@benninghoff1985man]. 
...
Moving into the mid-1990’s, the multi-disciplinary scope of large programmes of research like the McMurdo Dry Valleys Long Term Ecological Research (MCM LTER) programme, increased the number of researchers in the field but also supported more research into the history of human activity in the Dry Valleys [@priscu2016environmental]. 

With the introduction of the Committee for Environmental Protection (CEP) in 1998, human activities (including science activities) were monitored, but moved away from the understanding and scope of the activities, but more focused on the potential resulting impacts of the activity. 
For example, the current 5-year Work Plan for the CEP (REF), has several items associated with human activities but are focused on managing the impact of human activities rather than quantifying the current level of activity, or forecasting the cumulative impacts of the activity. 

More recent research has focused either on a continental-scale picture of human activity (Leihy et al), or detailed mapping of the infrastructural footprint and impacts that the numerous Antarctic stations have on the continent (Brooks et al x 2 Papers). 
These approaches approach the challenge of understanding human activity from contrasting spatial perspectives. 
This research aims to complement these two techniques using high resolution mapping of human activity in the dry valleys to extrapolate the way in which scientists use the landscape to move around.

**FRASER MATERIAL ENDS**
...
GPS data showing how scientists moved around the McMurdo Dry Valleys was collected using QStarz Q1100P GPS Tracking Recorders between 2016 and 2018. 
These units were selected because of their long battery life (40+ hours), chipset sensitivity, and simple design and use.

Each unit was set to record a location every 30 seconds. 
Scientists turned on the devices when leaving the base camp in the morning and turned them off when returning at the end of the day. 
The units were attached to the top of a backpack when leaving the camp to ensure the units had bread access to the GPS signal. 

Participants were sourced through existing networks of scientists supported by the New Zealand Antarctic Programme who were heading to Antarctica for research purposes. 
All participants were asked if they wish to wear a GPS recorder. 
The study was entirely voluntary. Over the two primary field events, 40 people used the devices. 
Social Ethics approval was received by the Manaaki Whenua Landcare Research Social Ethics committee (SE 1617/05).
...
![30 second locations recorded by ~14 researchers within a single research event within the Miers Valley. The image shows the basecamp, locations of research equipment and/or activities, as well as walking tracks that were taken to access areas further afield.](sample-gps-data.png){#fig-sample-gps-data fig-width="81.28mm"}
